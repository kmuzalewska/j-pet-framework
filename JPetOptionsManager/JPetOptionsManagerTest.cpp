...
#define BOOST_TEST_MODULE JPetOptionsManagerTest
#include <boost/test/unit_test.hpp>
#include "../JPetOptionsManager/JPetOptionsManager.h"
...
{
  JPetOptionsManager opts; 
  auto default_opts =  JPetOptionsManager::getDefaultOptions();
...
BOOST_AUTO_TEST_CASE(petOptionsBasicTest)
{
    ...
    JPetOptionsManager petOptions(options);
...
BOOST_AUTO_TEST_CASE(getTotalEventsTest)
{
    ...
    BOOST_REQUIRE_EQUAL(JPetOptionsManager(options).getTotalEvents(), -1);
    ...
    options.at("firstEvent")= "0";
    options.at("lastEvent")= "1";
    BOOST_REQUIRE_EQUAL(JPetOptionsManager(options).getTotalEvents(), 2);

    options.at("firstEvent")= "7";
    options.at("lastEvent")= "9";
    BOOST_REQUIRE_EQUAL(JPetOptionsManager(options).getTotalEvents(), 3);
